...
public class ActiveDisplaySettings extends SettingsPreferenceFragment implements
    ...
    private NEWSeekBarPreference mBrightnessLevel;
    private NEWSeekBarPreference mAnnoyingNotification;
    private NEWSeekBarPreference mShakeThreshold;
    private NEWSeekBarPreference mShakeLongThreshold;
    private NEWSeekBarPreference mShakeTimeout;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAnnoyingNotification = (NEWSeekBarPreference) prefSet.findPreference(KEY_ANNOYING);
        ...
        mShakeThreshold = (NEWSeekBarPreference) prefSet.findPreference(KEY_SHAKE_THRESHOLD);
        ...
        mShakeLongThreshold = (NEWSeekBarPreference) prefSet.findPreference(KEY_SHAKE_LONGTHRESHOLD);
        ...
        mShakeTimeout = (NEWSeekBarPreference) prefSet.findPreference(KEY_SHAKE_TIMEOUT);
        ...
        mBrightnessLevel = (NEWSeekBarPreference) prefSet.findPreference(KEY_BRIGHTNESS);
